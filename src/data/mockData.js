...
export const caseStudies = [
  {
    ...
    summary: 'Orchestrated regional press conferences, multi-lingual press releases (English, Marathi, Konkani), and stakeholder roundtables delivering extensive editorial coverage across regional dailies.',
    image: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=1800&q=80',
    featuredIn: ['Regional Print Dailies', 'Broadcast Television', 'Vernacular Press', 'Digital News Portals'],
    ...
    metrics: [
      { label: 'Audience Reach', value: '[Metric pending client data]' },
      { label: 'Print & TV Hits', value: '[Data in review]' },
      { label: 'Positive Sentiment', value: '[Metric pending client data]' },
      { label: 'Community Dialogues', value: '[Data in review]' }
    ]
  },
  {
    id: 'case-2',
    ...
    featuredIn: ['National Business Dailies', 'Regional Broadcast TV', 'Industry Portals', 'Trade Press'],
    ...
    metrics: [
      { label: 'AVE Generated', value: '[Metric pending client data]' },
      { label: 'Tier-1 Features', value: '[Data in review]' },
      { label: 'Executive Op-Eds', value: '[Data in review]' },
      { label: 'Crisis Mitigation', value: '[Metric pending client data]' }
    ]
  },
  {
    id: 'case-3',
    ...
    featuredIn: ['Digital Tech Portals', 'Regional Business Press', 'Syndication Networks', 'Trade Briefs'],
    ...
    metrics: [
      { label: 'Digital Traffic Lift', value: '[Metric pending client data]' },
      { label: 'Enterprise Systems', value: '[Data in review]' },
      { label: 'Search Authority', value: '[Metric pending client data]' },
      { label: 'Media Syndications', value: '[Data in review]' }
    ]
  }
];
